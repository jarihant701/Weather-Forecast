...
function DateWithTime(unixtimestamp) {
        ...
        var convdataTime = month+'-'+day+'-'+year+' '+hours + minutes.substr(-2)+seconds.substr(-2)+' hours';
...
$(document).ready(function(){
    ...
    $("#search").click(function() {
        ...
        $.ajax({
            ...
            var chartData = {
              labels: [convertDate(weatherdata.daily[0].dt), convertDate(weatherdata.daily[1].dt), convertDate(weatherdata.daily[2].dt), convertDate(weatherdata.daily[3].dt), convertDate(weatherdata.daily[4].dt), convertDate(weatherdata.daily[5].dt), convertDate(weatherdata.daily[6].dt)],
              datasets: [{
                data: [weatherdata.daily[0].temp.max, weatherdata.daily[1].temp.max,weatherdata.daily[2].temp.max,weatherdata.daily[3].temp.max, weatherdata.daily[4].temp.max, weatherdata.daily[5].temp.max, weatherdata.daily[6].temp.max, weatherdata.daily[7].temp.max],
               ...
               {
                 data: [weatherdata.daily[0].temp.min, weatherdata.daily[1].temp.min, weatherdata.daily[2].temp.min, weatherdata.daily[3].temp.min, weatherdata.daily[4].temp.min, weatherdata.daily[5].temp.min, weatherdata.daily[6].temp.min, weatherdata.daily[7].temp.min],
                 backgroundColor: 'transparent',
            ...
            error: function() {
                $("#landing").html("<p>No such place found! <br>Make sure u spell the name correctly</p>");
            }           
